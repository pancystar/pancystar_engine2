...
engine_basic::engine_fail_reason d3d_pancy_basic_singleton::save_texture(ID3D11Resource *resource_in, std::string name_file)
{
	...
	hr = DirectX::SaveToDDSFile(*tgadata.GetImages(), 0, data_output);
	if (FAILED(hr))
	{
